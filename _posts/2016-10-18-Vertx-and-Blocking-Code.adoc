...
In the shown code _executeBlocking_ is achieving the same work as the event bus pattern shown in the <<Worker Verticles>> example, but in a much more concise, efficient and less error-prone manner.
