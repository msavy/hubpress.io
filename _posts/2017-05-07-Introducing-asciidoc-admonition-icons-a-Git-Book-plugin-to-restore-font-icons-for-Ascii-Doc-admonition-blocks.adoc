...
:hp-tags: gitbook asciidoc asciidoctor
...
:gh-readme: https://github.com/msavy/gitbook-plugin-asciidoc-admonition-icons
...
Check out the plugin's {gh-readme}[GitHub repo], {gitbook-plugin-docs}[GitBook plugin page] or {npm}[NPM readme] for detailed instructions, including how to customise the glyphs and styling.
